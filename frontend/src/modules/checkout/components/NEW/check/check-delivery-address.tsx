...
const CheckDeliveryAddress = ({
    ...
    switch (color) {
      case 'green':
        ...
        return (
          <div className="flex items-center justify-between w-full px-4 py-2 rounded-lg transition-colors duration-300 text-white" style={{ backgroundColor: colorMap[color], /*color: color === 'yellow' ? '#fff' : '#fff'*/ }}>
            <div className="flex items-start space-x-4">
              <span className="text-3xl"><Check fill="white" size="48" /></span>
              <div className="text-left">
                <p className="font-semibold uppercase">Il servizio di consegna è disponibile nella tua zona</p>
                <p className="text-base-regular">Procedi con l'ordine</p>
