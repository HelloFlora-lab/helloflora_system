            ...
            {isLoading ? (
              ...
              <div className="text-center flex flex-col items-center gap-4">
                ...
                <div className="flex gap-4 mt-1 justify-center w-full">
                  <button onClick={handleGenerate} className="primary-btn animate-fade-in-up">Proponi altro</button>
                  <button onClick={handleRestart} className="primary-btn animate-fade-in-up">Ricomincia</button>
                </div>
              </div>
            )}
          </div>
    ...
    <div className="relative p-4 rounded-lg bg-theme-secondary-light outline-2 outline-offset-4 outline-dashed outline-gray-200">
      ...
      {/* Bordo tratteggiato esterno con offset */}
        ...
        <div className="relative z-10 mt-4 min-h-[230px] flex flex-col justify-center">
          <div className="text-center">
            <h3 className="h2-style font-semibold mt-8 mb-4"><IconAIAgent alt="AI Agent Icon" size={32} /> Flora AI</h3>
          </div>
          {renderStep()}
        </div>
    </div>
